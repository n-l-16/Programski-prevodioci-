...
has functions : setCategory with parameters category type of string , points type of float function scope is public and return type is void ,
                setCategory with parameters category type of string , points type of int function scope is protected and return type is void  
